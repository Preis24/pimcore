...
CREATE USER 'pimcore'@'%' IDENTIFIED BY 'passw0rd';
GRANT USAGE ON *.* TO 'pimcore'@'%';
GRANT ALL ON `pimcore`.* TO 'pimcore'@'%' WITH GRANT OPTION;
...
INSERT INTO `assets` VALUES (1,0,'folder','','/',NULL,1507541043,1507541043,1,1,NULL,0);
INSERT INTO `documents` VALUES (1,0,'page','','/',999999,1,1507541043,1507541043,1,1);
INSERT INTO `documents_page` VALUES (1,NULL,'default','default','','','',NULL,NULL,NULL,NULL,NULL);
INSERT INTO `objects` VALUES (1,0,'folder','','/',999999,1,1507541043,1507541043,1,1,NULL,NULL);
INSERT INTO `users` VALUES (0,0,'user','system',NULL,NULL,NULL,NULL,NULL,NULL,1,1,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,0,'user','admin','$2y$10$fZeqarDpfaiUcC151O3o9Ok3R.mK2u6a5StQfFHK6JqKP97uJdVpa',NULL,NULL,NULL,'en',NULL,1,1,'','',0,1,1,1,'','',NULL,NULL,'','','');
